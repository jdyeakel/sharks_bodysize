...
filename = "data/sharks_3oceans2/parameterest_data_full.jld";
namespace = smartpath(filename);
...
namespace = smartpath(filename);
@load namespace meanjuv meanadult peakjuvquant peakadultquant estmeanjuvG1 estvarjuvG1 estweightjuvG1 estmeanjuvG2 estvarjuvG2 estweightjuvG2 estmeanadultG1 estvaradultG1 estweightadultG1 estmeanadultG2 estvaradultG2 estweightadultG2 probunijuv probuniadult;
