function popgen_migrate_g_toothseasonality(m0,M,tempvec1,tempvec2,n0,gen,distance,velocity,D,sigtau,tau,toothlossratepercentchange)
    ...
    toothlossratebase = ((lowerteethlostperday + upperteethlostperday)/24/60/60); #*toothmass; 
    maxtoothlossrate = toothlossratebase*(1+toothlossratepercentchange);
    mintoothlossrate = toothlossratebase*(1-toothlossratepercentchange);
    ...
    let n=0, tcum = 0, tictoc = 0, day = 1 #n=0; tcum = 0; tictoc = 0; day = 1
        ...
        while tcum < tmax #&& tictoc < 1000000
            ...
            #Tooth drop
            toothdrop .+= state .* (toothlossrate[k1] * dt);
